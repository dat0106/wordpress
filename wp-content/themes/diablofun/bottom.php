        ...
        <div class='footer_txt'>
            <?php
                    if ($SMTheme->get( "layout","footertext" )) {
                        ...
                        ?><div style="float: left;"> Copyright &copy; 2000-<?php echo date("Y"); ?>  <a href="<?php echo home_url(); ?>"><?php bloginfo("name"); ?></a>, Inc<?php
                        echo (get_bloginfo('description'))?' - '.get_bloginfo('description'):'';
                    }
                ?></div>
                <div style="float: right;margin-right:40px">Designed and maintained by James Dat</div>
                <?php /*
