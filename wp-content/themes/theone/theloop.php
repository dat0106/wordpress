	...
	while (have_posts()) : the_post(); ?>
		<div class='one-post'>
			...
			if (!is_page()) {?><p class='post-meta'>
				...
				<span class='post-date'><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/smt/post-date.png"><?php echo get_the_date(); ?></span>
				...
				if(comments_open( get_the_ID() ))  {
                    ?>&nbsp;<span class='post-comments'><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/smt/comments.png"><?php comments_popup_link( $SMTheme->_( 'noresponses' ), $SMTheme->_( 'oneresponse' ), $SMTheme->_( 'multiresponse' ) ); ?></span>
				<?php } 
