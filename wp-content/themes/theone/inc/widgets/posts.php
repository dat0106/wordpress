        	...
        	<?php
				...
				foreach($posts as $p) {?>
                    <li>
						...
						<span class='date<?php if(has_post_thumbnail($p->ID)) echo ' has_thumb'?>'><span class='day'><?php echo $day; ?></span> <?php echo $month; ?></span>
						<?php } else $class='';?>
                        <?php if ( $instance['display_title'] ) { ?> <a href="<?php echo get_permalink($p->ID); ?>" rel="bookmark" class="widget-post-title" title="<?php echo $p->post_title; ?>"><?php echo $p->post_title?></a><?php } ?>
